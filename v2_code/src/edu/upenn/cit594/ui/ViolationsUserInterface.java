...
public class ViolationsUserInterface {
	...
	protected ArrayList<Population> totalPopulation;
	public ArrayList<Property> allProperties;
	public ArrayList<ParkingViolation> allViolations;
	...
	public void callUserFunction(int userAction) {
		...
		switch(userAction) {
			case 0:
				...
				break;
			case 1:
				int totalPop = analysis.totalPopulationForAllZIPCodes(totalPopulation);
				System.out.println(totalPop);
			    break;
			case 2:
				analysis.totalFinesPerCapita(allViolations, totalPopulation);
			    break;
			case 3:
				...
				try {
					...
					int avgMarketVal = analysis.averageResidentialMarketValueOrTotalLivableArea(zip, allProperties, calcMethod);
			...
			case 5:
				...
				try {
					zip = Integer.parseInt(userZIP);
					int mvPerCapita = analysis.totalResidentialMarketValuePerCapita(zip, allProperties, totalPopulation);
				...
				break;
			case 6:
				int highestAvgMV = analysis.highestAverageMarketValue(allProperties);
